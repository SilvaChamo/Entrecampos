...
const HeaderOld: React.FC = () => {
  ...
  return (
    <header>
      ...
      <div className={`py-5 transition-all duration-300 ${isScrolled ? 'fixed top-0 left-0 right-0 z-50 shadow-lg' : ''}`} style={{ backgroundColor: "#2d2d2d" }}>
        <div className="container mx-auto px-4">
          <div className="flex items-center justify-center gap-4">
            ...
            {isLoggedIn ? (
              ...
              <button onClick={() => setIsLoggedIn(true)} className="border border-white text-white px-[30px] py-2 rounded-full text-sm hover:bg-white hover:text-gray-800 transition-colors">
                Entrar
              </button>
            )}
          </div>
